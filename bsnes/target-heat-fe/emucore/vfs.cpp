...
auto EmuCore::Impl::openSave(const Media& media, const string& name, vfs::file::mode mode)
...
auto EmuCore::Impl::openFirmware(const string& name, vfs::file::mode mode)
    -> shared_pointer<vfs::file> {
...
auto EmuCore::Impl::openSuperFamicom(string name, vfs::file::mode mode)
    -> shared_pointer<vfs::file> {
...
auto EmuCore::Impl::open(uint id, string name, vfs::file::mode mode, bool required)
    -> shared_pointer<vfs::file> {
...
auto EmuCore::Impl::openMedia(uint id, string name, vfs::file::mode mode)
    -> shared_pointer<vfs::file> {
