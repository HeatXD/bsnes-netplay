...
memory.write_u32_le(0x7e1ff0, 0x80ff8000)
assert(memory.read_s8(0x7e1ff0) == 0)
assert(memory.read_s16_le(0x7e1ff0) == -32768)
assert(memory.read_s16_be(0x7e1ff2) == -128)
assert(memory.read_s24_le(0x7e1ff1) == -8323200)
assert(memory.read_s32_le(0x7e1ff0) == -2130739200)

memory.write_s8(0x7e1ff0, -1)
assert(memory.read_u8(0x7e1ff0) == 0xff)
memory.write_s16_le(0x7e1ff1, -32768)
assert(memory.read_u16_le(0x7e1ff1) == 0x8000)
memory.write_s24_be(0x7e1ff3, -2)
assert(memory.read_u24_be(0x7e1ff3) == 0xfffffe)
memory.write_s32_le(0x7e1ff6, -2147483648)
assert(memory.read_u32_le(0x7e1ff6) == 0x80000000)
